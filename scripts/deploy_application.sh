...
# Clone code
git clone git@github.com:rdsea/holisticPolicy.git
...
kubectl apply -f applications/object_classification/src/deployment/preprocessing.yml
kubectl apply -f applications/object_classification/src/deployment/ensemble.yml
